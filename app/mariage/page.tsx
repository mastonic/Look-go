...
export default function WeddingPage(){
 ...
 async function save(e:FormEvent<HTMLFormElement>){
  e.preventDefault();const currentProfile=profile;if(!currentProfile)return;setError("");setMessage("");setSaving(true);
  ...
  const event:WeddingEvent={
   ...
   budget:Math.max(50,Number(fd.get("budget")||currentProfile.budget||250)),
  ...
  const next={...currentProfile,wedding:event};
